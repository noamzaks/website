...
ogDescription: You have n boxes organized in a circle, where each box contains a ball. You are only allowed to move two balls to adjacent boxes in opposite directions (clockwise and counter-clockwise). Given n, determine if you can move all the balls to a single box.
